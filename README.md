...
.syntax--source.syntax--python .syntax--variable.syntax--parameter {
  ...
  <body class='markdown-preview' data-use-github-style><h1 id="serial-communication-between-max-and-arduino">Serial Communication between MAX and Arduino</h1>
<p>For reading any number. </p>
<pre class="editor-colors lang-text"><div class="line"><span class="syntax--text syntax--plain"><span class="syntax--meta syntax--paragraph syntax--text">Separate by ,</span></span></div></pre><p><strong>credit</strong></p>
<p>David A. Mellis
modified 14 Apr 2009
by Scott Fitzgerald and Tom Igoe</p></body>
</html>
